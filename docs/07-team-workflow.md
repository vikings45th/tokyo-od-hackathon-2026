...
3. 既存環境にホバー → 右に出る**歯車アイコン**を選択
   （新しく作る場合は **Add cloud environment**）
4. **Network access** を **Custom** に変更
5. **Allowed domains** に下のリストを貼り付け（1行1ドメイン）
6. **「Also include default list of common package managers」に必ずチェックを入れる**
